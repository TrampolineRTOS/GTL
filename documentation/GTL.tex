...
\draw (.5,10.5) node[right] {\huge Version 3.0.15};
...
\subsubsection{The \texttt{trimWhiteSpaces} getter}

\gtlinline{trimWhiteSpaces} returns the target string without the leading and trailing white spaces.

...
\lstinline{limit_expression} is an optional expression to bound the number of iterations. If the number of iterations exceeds \lstinline{limit}, a runtime error is emitted. If \lstinline{limit_expression} is omitted, the number of iterations is bounded to $2^{32}-1$.

...
void routine_argumentsCheck (const GALGAS_lstring constinArgument_methodName,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsNotEqual, inArgument_abstractArgumentList.getter_length (SOURCE_FILE ("gtl_data_types.galgas", 166)).objectCompare (inArgument_concreteArgumentList.getter_length (SOURCE_FILE ("gtl_data_types.galgas", 166)))).boolEnum () ;
    if (kBoolTrue == test_0) {
  ...
  if (kBoolFalse == test_0) {
    ...
    if (kBoolFalse == test_2) {
      ...
      if (kBoolFalse == test_3) {
        ...
        if (kBoolTrue == test_4) {
          test_4 = callExtensionGetter_getterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("unconstructed"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 489)).boolEnum () ;
          if (kBoolTrue == test_4) {
...
static void extensionSetter_gtlUnconstructed_performSetter (cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string ("setDescription").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 511)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      ...
      GALGAS_gtlString var_descriptionToSet_15967 = temp_1 ;
      {
      object->setter_setMeta (callExtensionGetter_lstring ((const cPtr_gtlString *) var_descriptionToSet_15967.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 514)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 514)) ;
      }
  ...
  if (kBoolFalse == test_0) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (kIsEqual, GALGAS_string ("touch").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 516)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
    ...
    if (kBoolFalse == test_2) {
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        test_3 = callExtensionGetter_setterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("unconstructed"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 519)).boolEnum () ;
        if (kBoolTrue == test_3) {
          const GALGAS_gtlUnconstructed temp_4 = object ;
          GALGAS_gtlData var_copy_16272 = temp_4 ;
          callExtensionMethod_callSetter ((const cPtr_gtlSetter *) callExtensionGetter_getSetter ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("unconstructed"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 521)).ptr (), constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 522)), constinArgument_context, constinArgument_lib, var_copy_16272, constinArgument_arguments, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 521)) ;
          object->mProperty_where = var_copy_16272.getter_where (SOURCE_FILE ("gtl_data_types.galgas", 528)) ;
          object->mProperty_meta = var_copy_16272.getter_meta (SOURCE_FILE ("gtl_data_types.galgas", 529)) ;
        }
      }
      if (kBoolFalse == test_3) {
...
static GALGAS_gtlData extensionGetter_gtlType_performGetter (const cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string ("string").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 653)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
  ...
  if (kBoolFalse == test_0) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (kIsEqual, GALGAS_string ("type").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 658)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
    ...
    if (kBoolFalse == test_2) {
      enumGalgasBool test_4 = kBoolTrue ;
      if (kBoolTrue == test_4) {
        test_4 = GALGAS_bool (kIsEqual, GALGAS_string ("isANumber").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 663)))).boolEnum () ;
        if (kBoolTrue == test_4) {
          {
      ...
      if (kBoolFalse == test_4) {
        ...
        if (kBoolTrue == test_5) {
          test_5 = GALGAS_bool (kIsEqual, GALGAS_string ("description").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 668)))).boolEnum () ;
          if (kBoolTrue == test_5) {
            {
        ...
        if (kBoolFalse == test_5) {
          ...
          if (kBoolTrue == test_6) {
            test_6 = callExtensionGetter_getterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("type"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 673)).boolEnum () ;
            if (kBoolTrue == test_6) {
...
static void extensionSetter_gtlType_performSetter (cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string ("setDescription").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 695)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      ...
      GALGAS_gtlString var_descriptionToSet_22116 = temp_1 ;
      {
      object->setter_setMeta (callExtensionGetter_lstring ((const cPtr_gtlString *) var_descriptionToSet_22116.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 698)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 698)) ;
      }
  ...
  if (kBoolFalse == test_0) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (kIsEqual, GALGAS_string ("touch").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 700)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
    ...
    if (kBoolFalse == test_2) {
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        test_3 = callExtensionGetter_setterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("type"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 703)).boolEnum () ;
        if (kBoolTrue == test_3) {
          const GALGAS_gtlType temp_4 = object ;
          GALGAS_gtlData var_copy_22412 = temp_4 ;
          callExtensionMethod_callSetter ((const cPtr_gtlSetter *) callExtensionGetter_getSetter ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("type"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 705)).ptr (), constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 706)), constinArgument_context, constinArgument_lib, var_copy_22412, constinArgument_arguments, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 705)) ;
          GALGAS_gtlType temp_5 ;
          if (var_copy_22412.isValid ()) {
            if (NULL != dynamic_cast <const cPtr_gtlType *> (var_copy_22412.ptr ())) {
              temp_5 = (cPtr_gtlType *) var_copy_22412.ptr () ;
            }else{
              inCompiler->castError ("gtlType", var_copy_22412.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("gtl_data_types.galgas", 712)) ;
            }
          }
          object->mProperty_type = temp_5.getter_type (SOURCE_FILE ("gtl_data_types.galgas", 712)) ;
          object->mProperty_where = var_copy_22412.getter_where (SOURCE_FILE ("gtl_data_types.galgas", 713)) ;
          object->mProperty_meta = var_copy_22412.getter_meta (SOURCE_FILE ("gtl_data_types.galgas", 714)) ;
        }
      }
      if (kBoolFalse == test_3) {
        TC_Array <C_FixItDescription> fixItArray6 ;
...
static GALGAS_gtlData extensionGetter_gtlEnum_performGetter (const cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string ("string").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 845)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
  ...
  if (kBoolFalse == test_0) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (kIsEqual, GALGAS_string ("type").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 850)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
    ...
    if (kBoolFalse == test_2) {
      enumGalgasBool test_4 = kBoolTrue ;
      if (kBoolTrue == test_4) {
        test_4 = GALGAS_bool (kIsEqual, GALGAS_string ("isANumber").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 855)))).boolEnum () ;
        if (kBoolTrue == test_4) {
          {
      ...
      if (kBoolFalse == test_4) {
        enumGalgasBool test_5 = kBoolTrue ;
        if (kBoolTrue == test_5) {
          test_5 = GALGAS_bool (kIsEqual, GALGAS_string ("description").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 860)))).boolEnum () ;
          if (kBoolTrue == test_5) {
            {
        ...
        if (kBoolFalse == test_5) {
          enumGalgasBool test_6 = kBoolTrue ;
          if (kBoolTrue == test_6) {
            test_6 = callExtensionGetter_getterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("enum"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 865)).boolEnum () ;
            if (kBoolTrue == test_6) {
...
static void extensionSetter_gtlEnum_performSetter (cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string ("setDescription").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 887)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      ...
      GALGAS_gtlString var_descriptionToSet_28395 = temp_1 ;
      {
      object->setter_setMeta (callExtensionGetter_lstring ((const cPtr_gtlString *) var_descriptionToSet_28395.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 890)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 890)) ;
      }
  ...
  if (kBoolFalse == test_0) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (kIsEqual, GALGAS_string ("touch").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 892)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
    ...
    if (kBoolFalse == test_2) {
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        test_3 = callExtensionGetter_setterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("enum"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 895)).boolEnum () ;
        if (kBoolTrue == test_3) {
          const GALGAS_gtlEnum temp_4 = object ;
          GALGAS_gtlData var_copy_28691 = temp_4 ;
          callExtensionMethod_callSetter ((const cPtr_gtlSetter *) callExtensionGetter_getSetter ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("enum"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 897)).ptr (), constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 898)), constinArgument_context, constinArgument_lib, var_copy_28691, constinArgument_arguments, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 897)) ;
          GALGAS_gtlEnum temp_5 ;
          if (var_copy_28691.isValid ()) {
            if (NULL != dynamic_cast <const cPtr_gtlEnum *> (var_copy_28691.ptr ())) {
              temp_5 = (cPtr_gtlEnum *) var_copy_28691.ptr () ;
            }else{
              inCompiler->castError ("gtlEnum", var_copy_28691.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("gtl_data_types.galgas", 904)) ;
            }
          }
          object->mProperty_value = temp_5.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 904)) ;
          object->mProperty_where = var_copy_28691.getter_where (SOURCE_FILE ("gtl_data_types.galgas", 905)) ;
          object->mProperty_meta = var_copy_28691.getter_meta (SOURCE_FILE ("gtl_data_types.galgas", 906)) ;
        }
      }
      if (kBoolFalse == test_3) {
        TC_Array <C_FixItDescription> fixItArray6 ;
...
static GALGAS_gtlData extensionGetter_gtlChar_performGetter (const cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string ("string").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1087)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
  ...
  if (kBoolFalse == test_0) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (kIsEqual, GALGAS_string ("isAlnum").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1092)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
    ...
    if (kBoolFalse == test_2) {
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        test_3 = GALGAS_bool (kIsEqual, GALGAS_string ("isCntrl").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1097)))).boolEnum () ;
        if (kBoolTrue == test_3) {
          {
      ...
      if (kBoolFalse == test_3) {
        enumGalgasBool test_4 = kBoolTrue ;
        if (kBoolTrue == test_4) {
          test_4 = GALGAS_bool (kIsEqual, GALGAS_string ("isDigit").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1102)))).boolEnum () ;
          if (kBoolTrue == test_4) {
            {
        ...
        if (kBoolFalse == test_4) {
          enumGalgasBool test_5 = kBoolTrue ;
          if (kBoolTrue == test_5) {
            test_5 = GALGAS_bool (kIsEqual, GALGAS_string ("isAlpha").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1107)))).boolEnum () ;
            if (kBoolTrue == test_5) {
              {
          ...
          if (kBoolFalse == test_5) {
            enumGalgasBool test_6 = kBoolTrue ;
            if (kBoolTrue == test_6) {
              test_6 = GALGAS_bool (kIsEqual, GALGAS_string ("isLower").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1112)))).boolEnum () ;
              if (kBoolTrue == test_6) {
                {
            ...
            if (kBoolFalse == test_6) {
              ...
              if (kBoolTrue == test_7) {
                test_7 = GALGAS_bool (kIsEqual, GALGAS_string ("isUpper").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1117)))).boolEnum () ;
                if (kBoolTrue == test_7) {
                  {
              ...
              if (kBoolFalse == test_7) {
                ...
                if (kBoolTrue == test_8) {
                  test_8 = GALGAS_bool (kIsEqual, GALGAS_string ("isXDigit").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1122)))).boolEnum () ;
                  if (kBoolTrue == test_8) {
                    {
                ...
                if (kBoolFalse == test_8) {
                  ...
                  if (kBoolTrue == test_9) {
                    test_9 = GALGAS_bool (kIsEqual, GALGAS_string ("type").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1127)))).boolEnum () ;
                    if (kBoolTrue == test_9) {
                      {
                  ...
                  if (kBoolFalse == test_9) {
                    ...
                    if (kBoolTrue == test_11) {
                      test_11 = GALGAS_bool (kIsEqual, GALGAS_string ("isANumber").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1132)))).boolEnum () ;
                      if (kBoolTrue == test_11) {
                        {
                    ...
                    if (kBoolFalse == test_11) {
                      ...
                      if (kBoolTrue == test_12) {
                        test_12 = GALGAS_bool (kIsEqual, GALGAS_string ("description").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1137)))).boolEnum () ;
                        if (kBoolTrue == test_12) {
                          {
                      ...
                      if (kBoolFalse == test_12) {
                        ...
                        if (kBoolTrue == test_13) {
                          test_13 = callExtensionGetter_getterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("char"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1142)).boolEnum () ;
                          if (kBoolTrue == test_13) {
...
static void extensionSetter_gtlChar_performSetter (cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string ("setDescription").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1164)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      ...
      GALGAS_gtlString var_descriptionToSet_36657 = temp_1 ;
      {
      object->setter_setMeta (callExtensionGetter_lstring ((const cPtr_gtlString *) var_descriptionToSet_36657.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1167)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1167)) ;
      }
  ...
  if (kBoolFalse == test_0) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (kIsEqual, GALGAS_string ("touch").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1169)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
    ...
    if (kBoolFalse == test_2) {
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        test_3 = callExtensionGetter_setterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("char"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1172)).boolEnum () ;
        if (kBoolTrue == test_3) {
          const GALGAS_gtlChar temp_4 = object ;
          GALGAS_gtlData var_copy_36953 = temp_4 ;
          callExtensionMethod_callSetter ((const cPtr_gtlSetter *) callExtensionGetter_getSetter ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("char"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1174)).ptr (), constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 1175)), constinArgument_context, constinArgument_lib, var_copy_36953, constinArgument_arguments, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1174)) ;
          GALGAS_gtlChar temp_5 ;
          if (var_copy_36953.isValid ()) {
            if (NULL != dynamic_cast <const cPtr_gtlChar *> (var_copy_36953.ptr ())) {
              temp_5 = (cPtr_gtlChar *) var_copy_36953.ptr () ;
            }else{
              inCompiler->castError ("gtlChar", var_copy_36953.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1181)) ;
            }
          }
          object->mProperty_value = temp_5.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 1181)) ;
          object->mProperty_where = var_copy_36953.getter_where (SOURCE_FILE ("gtl_data_types.galgas", 1182)) ;
          object->mProperty_meta = var_copy_36953.getter_meta (SOURCE_FILE ("gtl_data_types.galgas", 1183)) ;
        }
      }
      if (kBoolFalse == test_3) {
        TC_Array <C_FixItDescription> fixItArray6 ;
...
static GALGAS_gtlData extensionGetter_gtlInt_slOp (const cPtr_gtlData * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_bigint var_r_40785 = temp_1.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 1328)) ;
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        test_2 = GALGAS_bool (kIsSupOrEqual, var_r_40785.objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1329)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          ...
          result_result = GALGAS_gtlInt::constructor_new (object->mProperty_where, function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1332)), object->mProperty_value.left_shift_operation (temp_3.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 1333)).getter_uint (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1333)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1333))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1330)) ;
        }
      }
      if (kBoolFalse == test_2) {
...
static GALGAS_gtlData extensionGetter_gtlInt_srOp (const cPtr_gtlData * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_bigint var_r_41219 = temp_1.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 1345)) ;
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        test_2 = GALGAS_bool (kIsSupOrEqual, var_r_41219.objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1346)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          result_result = GALGAS_gtlInt::constructor_new (object->mProperty_where, function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1347)), object->mProperty_value.right_shift_operation (var_r_41219.getter_uint (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1347)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1347))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1347)) ;
        }
      }
      if (kBoolFalse == test_2) {
        TC_Array <C_FixItDescription> fixItArray3 ;
...
static GALGAS_gtlData extensionGetter_gtlInt_performGetter (const cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string ("string").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1448)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
  ...
  if (kBoolFalse == test_0) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (kIsEqual, GALGAS_string ("padded").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1453)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        ...
        GALGAS_uint var_fieldSize_44041 = temp_3.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 1455)).getter_uint (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1455)) ;
        const GALGAS_gtlInt temp_4 = object ;
        result_result = GALGAS_gtlString::constructor_new (constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 1457)), function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1458)), callExtensionGetter_string ((const cPtr_gtlInt *) temp_4.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1459)).getter_stringByLeftAndRightPadding (var_fieldSize_44041, GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1459))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1456)) ;
      }
    }
    if (kBoolFalse == test_2) {
      enumGalgasBool test_5 = kBoolTrue ;
      if (kBoolTrue == test_5) {
        test_5 = GALGAS_bool (kIsEqual, GALGAS_string ("leftPadded").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1461)))).boolEnum () ;
        if (kBoolTrue == test_5) {
          {
          ...
          GALGAS_uint var_fieldSize_44382 = temp_6.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 1463)).getter_uint (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1463)) ;
          const GALGAS_gtlInt temp_7 = object ;
          result_result = GALGAS_gtlString::constructor_new (constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 1465)), function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1466)), callExtensionGetter_string ((const cPtr_gtlInt *) temp_7.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1467)).getter_stringByLeftPadding (var_fieldSize_44382, GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1467))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1464)) ;
        }
      }
      if (kBoolFalse == test_5) {
        enumGalgasBool test_8 = kBoolTrue ;
        if (kBoolTrue == test_8) {
          test_8 = GALGAS_bool (kIsEqual, GALGAS_string ("rightPadded").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1469)))).boolEnum () ;
          if (kBoolTrue == test_8) {
            {
            ...
            GALGAS_uint var_fieldSize_44717 = temp_9.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 1471)).getter_uint (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1471)) ;
            const GALGAS_gtlInt temp_10 = object ;
            result_result = GALGAS_gtlString::constructor_new (constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 1473)), function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1474)), callExtensionGetter_string ((const cPtr_gtlInt *) temp_10.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1475)).getter_stringByRightPadding (var_fieldSize_44717, GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1475))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1472)) ;
          }
        }
        if (kBoolFalse == test_8) {
          enumGalgasBool test_11 = kBoolTrue ;
          if (kBoolTrue == test_11) {
            test_11 = GALGAS_bool (kIsEqual, GALGAS_string ("hexString").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1477)))).boolEnum () ;
            if (kBoolTrue == test_11) {
              {
          ...
          if (kBoolFalse == test_11) {
            enumGalgasBool test_12 = kBoolTrue ;
            if (kBoolTrue == test_12) {
              test_12 = GALGAS_bool (kIsEqual, GALGAS_string ("xString").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1482)))).boolEnum () ;
              if (kBoolTrue == test_12) {
                {
            ...
            if (kBoolFalse == test_12) {
              enumGalgasBool test_13 = kBoolTrue ;
              if (kBoolTrue == test_13) {
                test_13 = GALGAS_bool (kIsEqual, GALGAS_string ("numberOfBytes").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1487)))).boolEnum () ;
                if (kBoolTrue == test_13) {
                  {
              ...
              if (kBoolFalse == test_13) {
                ...
                if (kBoolTrue == test_14) {
                  test_14 = GALGAS_bool (kIsEqual, GALGAS_string ("signedNumberOfBytes").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1494)))).boolEnum () ;
                  if (kBoolTrue == test_14) {
                    {
                ...
                if (kBoolFalse == test_14) {
                  ...
                  if (kBoolTrue == test_15) {
                    test_15 = GALGAS_bool (kIsEqual, GALGAS_string ("numberOfBits").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1501)))).boolEnum () ;
                    if (kBoolTrue == test_15) {
                      {
                  ...
                  if (kBoolFalse == test_15) {
                    ...
                    if (kBoolTrue == test_16) {
                      test_16 = GALGAS_bool (kIsEqual, GALGAS_string ("signedNumberOfBits").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1508)))).boolEnum () ;
                      if (kBoolTrue == test_16) {
                        {
                    ...
                    if (kBoolFalse == test_16) {
                      ...
                      if (kBoolTrue == test_17) {
                        test_17 = GALGAS_bool (kIsEqual, GALGAS_string ("sign").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1515)))).boolEnum () ;
                        if (kBoolTrue == test_17) {
                          {
                      ...
                      if (kBoolFalse == test_17) {
                        ...
                        if (kBoolTrue == test_18) {
                          test_18 = GALGAS_bool (kIsEqual, GALGAS_string ("fitsUnsignedInByte").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1522)))).boolEnum () ;
                          if (kBoolTrue == test_18) {
                            {
                        ...
                        if (kBoolFalse == test_18) {
                          ...
                          if (kBoolTrue == test_19) {
                            test_19 = GALGAS_bool (kIsEqual, GALGAS_string ("fitsSignedInByte").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1529)))).boolEnum () ;
                            if (kBoolTrue == test_19) {
                              {
                          ...
                          if (kBoolFalse == test_19) {
                            ...
                            if (kBoolTrue == test_20) {
                              test_20 = GALGAS_bool (kIsEqual, GALGAS_string ("fitsUnsignedInShort").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1536)))).boolEnum () ;
                              if (kBoolTrue == test_20) {
                                {
                            ...
                            if (kBoolFalse == test_20) {
                              ...
                              if (kBoolTrue == test_21) {
                                test_21 = GALGAS_bool (kIsEqual, GALGAS_string ("fitsSignedInShort").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1543)))).boolEnum () ;
                                if (kBoolTrue == test_21) {
                                  {
                              ...
                              if (kBoolFalse == test_21) {
                                ...
                                if (kBoolTrue == test_22) {
                                  test_22 = GALGAS_bool (kIsEqual, GALGAS_string ("fitsUnsignedInLong").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1550)))).boolEnum () ;
                                  if (kBoolTrue == test_22) {
                                    {
                                ...
                                if (kBoolFalse == test_22) {
                                  ...
                                  if (kBoolTrue == test_23) {
                                    test_23 = GALGAS_bool (kIsEqual, GALGAS_string ("fitsSignedInLong").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1557)))).boolEnum () ;
                                    if (kBoolTrue == test_23) {
                                      {
                                  ...
                                  if (kBoolFalse == test_23) {
                                    ...
                                    if (kBoolTrue == test_24) {
                                      test_24 = GALGAS_bool (kIsEqual, GALGAS_string ("fitsUnsignedInLongLong").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1564)))).boolEnum () ;
                                      if (kBoolTrue == test_24) {
                                        {
                                    ...
                                    if (kBoolFalse == test_24) {
                                      ...
                                      if (kBoolTrue == test_25) {
                                        test_25 = GALGAS_bool (kIsEqual, GALGAS_string ("fitsSignedInLongLong").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1571)))).boolEnum () ;
                                        if (kBoolTrue == test_25) {
                                          {
                                      ...
                                      if (kBoolFalse == test_25) {
                                        ...
                                        if (kBoolTrue == test_26) {
                                          test_26 = GALGAS_bool (kIsEqual, GALGAS_string ("abs").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1578)))).boolEnum () ;
                                          if (kBoolTrue == test_26) {
                                            {
                                        ...
                                        if (kBoolFalse == test_26) {
                                          ...
                                          if (kBoolTrue == test_27) {
                                            test_27 = GALGAS_bool (kIsEqual, GALGAS_string ("bitAtIndex").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1585)))).boolEnum () ;
                                            if (kBoolTrue == test_27) {
                                              {
                                              ...
                                              GALGAS_uint var_index_48913 = temp_28.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 1587)).getter_uint (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1587)) ;
                                              result_result = GALGAS_gtlBool::constructor_new (constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 1589)), function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1590)), object->mProperty_value.getter_bitAtIndex (var_index_48913 COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1591))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1588)) ;
                                            }
                                          }
                                          if (kBoolFalse == test_27) {
                                            enumGalgasBool test_29 = kBoolTrue ;
                                            if (kBoolTrue == test_29) {
                                              test_29 = GALGAS_bool (kIsEqual, GALGAS_string ("type").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1593)))).boolEnum () ;
                                              if (kBoolTrue == test_29) {
                                                {
                                            ...
                                            if (kBoolFalse == test_29) {
                                              ...
                                              if (kBoolTrue == test_31) {
                                                test_31 = GALGAS_bool (kIsEqual, GALGAS_string ("isANumber").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1598)))).boolEnum () ;
                                                if (kBoolTrue == test_31) {
                                                  {
                                              ...
                                              if (kBoolFalse == test_31) {
                                                ...
                                                if (kBoolTrue == test_32) {
                                                  test_32 = GALGAS_bool (kIsEqual, GALGAS_string ("description").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1603)))).boolEnum () ;
                                                  if (kBoolTrue == test_32) {
                                                    {
                                                ...
                                                if (kBoolFalse == test_32) {
                                                  ...
                                                  if (kBoolTrue == test_33) {
                                                    test_33 = callExtensionGetter_getterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("int"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1608)).boolEnum () ;
                                                    if (kBoolTrue == test_33) {
...
static void extensionSetter_gtlInt_performSetter (cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1630)).objectCompare (GALGAS_string ("setBitAtIndex"))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      ...
      GALGAS_bool var_bit_50419 = temp_1.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 1632)) ;
      ...
      GALGAS_uint var_index_50484 = temp_2.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 1633)).getter_uint (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1633)) ;
      {
      object->mProperty_value.setter_setBitAtIndex (var_bit_50419, var_index_50484 COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1634)) ;
      }
  ...
  if (kBoolFalse == test_0) {
    enumGalgasBool test_3 = kBoolTrue ;
    if (kBoolTrue == test_3) {
      test_3 = GALGAS_bool (kIsEqual, constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1636)).objectCompare (GALGAS_string ("complementBitAtIndex"))).boolEnum () ;
      if (kBoolTrue == test_3) {
        {
        ...
        GALGAS_uint var_index_50735 = temp_4.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 1638)).getter_uint (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1638)) ;
        {
        object->mProperty_value.setter_complementBitAtIndex (var_index_50735 COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1639)) ;
        }
    ...
    if (kBoolFalse == test_3) {
      enumGalgasBool test_5 = kBoolTrue ;
      if (kBoolTrue == test_5) {
        test_5 = GALGAS_bool (kIsEqual, GALGAS_string ("setDescription").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1641)))).boolEnum () ;
        if (kBoolTrue == test_5) {
          {
          ...
          GALGAS_gtlString var_descriptionToSet_50992 = temp_6 ;
          {
          object->setter_setMeta (callExtensionGetter_lstring ((const cPtr_gtlString *) var_descriptionToSet_50992.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1644)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1644)) ;
          }
      ...
      if (kBoolFalse == test_5) {
        enumGalgasBool test_7 = kBoolTrue ;
        if (kBoolTrue == test_7) {
          test_7 = GALGAS_bool (kIsEqual, GALGAS_string ("touch").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1646)))).boolEnum () ;
          if (kBoolTrue == test_7) {
            {
        ...
        if (kBoolFalse == test_7) {
          enumGalgasBool test_8 = kBoolTrue ;
          if (kBoolTrue == test_8) {
            test_8 = callExtensionGetter_setterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("int"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1649)).boolEnum () ;
            if (kBoolTrue == test_8) {
              const GALGAS_gtlInt temp_9 = object ;
              GALGAS_gtlData var_copy_51287 = temp_9 ;
              callExtensionMethod_callSetter ((const cPtr_gtlSetter *) callExtensionGetter_getSetter ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("int"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1651)).ptr (), constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 1652)), constinArgument_context, constinArgument_lib, var_copy_51287, constinArgument_arguments, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1651)) ;
              GALGAS_gtlInt temp_10 ;
              if (var_copy_51287.isValid ()) {
                if (NULL != dynamic_cast <const cPtr_gtlInt *> (var_copy_51287.ptr ())) {
                  temp_10 = (cPtr_gtlInt *) var_copy_51287.ptr () ;
                }else{
                  inCompiler->castError ("gtlInt", var_copy_51287.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1658)) ;
                }
              }
              object->mProperty_value = temp_10.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 1658)) ;
              object->mProperty_where = var_copy_51287.getter_where (SOURCE_FILE ("gtl_data_types.galgas", 1659)) ;
              object->mProperty_meta = var_copy_51287.getter_meta (SOURCE_FILE ("gtl_data_types.galgas", 1660)) ;
            }
          }
          if (kBoolFalse == test_8) {
...
static GALGAS_gtlData extensionGetter_gtlFloat_performGetter (const cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string ("string").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1871)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
  ...
  if (kBoolFalse == test_0) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (kIsEqual, GALGAS_string ("cos").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1876)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
    ...
    if (kBoolFalse == test_2) {
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        test_3 = GALGAS_bool (kIsEqual, GALGAS_string ("sin").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1881)))).boolEnum () ;
        if (kBoolTrue == test_3) {
          {
      ...
      if (kBoolFalse == test_3) {
        enumGalgasBool test_4 = kBoolTrue ;
        if (kBoolTrue == test_4) {
          test_4 = GALGAS_bool (kIsEqual, GALGAS_string ("tan").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1886)))).boolEnum () ;
          if (kBoolTrue == test_4) {
            {
        ...
        if (kBoolFalse == test_4) {
          enumGalgasBool test_5 = kBoolTrue ;
          if (kBoolTrue == test_5) {
            test_5 = GALGAS_bool (kIsEqual, GALGAS_string ("cosDegree").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1891)))).boolEnum () ;
            if (kBoolTrue == test_5) {
              {
          ...
          if (kBoolFalse == test_5) {
            enumGalgasBool test_6 = kBoolTrue ;
            if (kBoolTrue == test_6) {
              test_6 = GALGAS_bool (kIsEqual, GALGAS_string ("sinDegree").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1896)))).boolEnum () ;
              if (kBoolTrue == test_6) {
                {
            ...
            if (kBoolFalse == test_6) {
              enumGalgasBool test_7 = kBoolTrue ;
              if (kBoolTrue == test_7) {
                test_7 = GALGAS_bool (kIsEqual, GALGAS_string ("tanDegree").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1901)))).boolEnum () ;
                if (kBoolTrue == test_7) {
                  {
              ...
              if (kBoolFalse == test_7) {
                enumGalgasBool test_8 = kBoolTrue ;
                if (kBoolTrue == test_8) {
                  test_8 = GALGAS_bool (kIsEqual, GALGAS_string ("exp").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1906)))).boolEnum () ;
                  if (kBoolTrue == test_8) {
                    {
                ...
                if (kBoolFalse == test_8) {
                  enumGalgasBool test_9 = kBoolTrue ;
                  if (kBoolTrue == test_9) {
                    test_9 = GALGAS_bool (kIsEqual, GALGAS_string ("logn").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1911)))).boolEnum () ;
                    if (kBoolTrue == test_9) {
                      {
                  ...
                  if (kBoolFalse == test_9) {
                    ...
                    if (kBoolTrue == test_10) {
                      test_10 = GALGAS_bool (kIsEqual, GALGAS_string ("log2").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1916)))).boolEnum () ;
                      if (kBoolTrue == test_10) {
                        {
                    ...
                    if (kBoolFalse == test_10) {
                      enumGalgasBool test_11 = kBoolTrue ;
                      if (kBoolTrue == test_11) {
                        test_11 = GALGAS_bool (kIsEqual, GALGAS_string ("log10").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1921)))).boolEnum () ;
                        if (kBoolTrue == test_11) {
                          {
                      ...
                      if (kBoolFalse == test_11) {
                        enumGalgasBool test_12 = kBoolTrue ;
                        if (kBoolTrue == test_12) {
                          test_12 = GALGAS_bool (kIsEqual, GALGAS_string ("sqrt").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1926)))).boolEnum () ;
                          if (kBoolTrue == test_12) {
                            {
                        ...
                        if (kBoolFalse == test_12) {
                          enumGalgasBool test_13 = kBoolTrue ;
                          if (kBoolTrue == test_13) {
                            test_13 = GALGAS_bool (kIsEqual, GALGAS_string ("power").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1931)))).boolEnum () ;
                            if (kBoolTrue == test_13) {
                              {
                              ...
                              GALGAS_double var_power_59533 = temp_14.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 1933)) ;
                              result_result = GALGAS_gtlFloat::constructor_new (constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 1935)), function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1935)), object->mProperty_value.getter_power (var_power_59533, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1935))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1934)) ;
                            }
                          }
                          if (kBoolFalse == test_13) {
                            enumGalgasBool test_15 = kBoolTrue ;
                            if (kBoolTrue == test_15) {
                              test_15 = GALGAS_bool (kIsEqual, GALGAS_string ("type").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1937)))).boolEnum () ;
                              if (kBoolTrue == test_15) {
                                {
                            ...
                            if (kBoolFalse == test_15) {
                              enumGalgasBool test_17 = kBoolTrue ;
                              if (kBoolTrue == test_17) {
                                test_17 = GALGAS_bool (kIsEqual, GALGAS_string ("isANumber").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1942)))).boolEnum () ;
                                if (kBoolTrue == test_17) {
                                  {
                              ...
                              if (kBoolFalse == test_17) {
                                enumGalgasBool test_18 = kBoolTrue ;
                                if (kBoolTrue == test_18) {
                                  test_18 = GALGAS_bool (kIsEqual, GALGAS_string ("int").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1947)))).boolEnum () ;
                                  if (kBoolTrue == test_18) {
                                    {
                                ...
                                if (kBoolFalse == test_18) {
                                  enumGalgasBool test_19 = kBoolTrue ;
                                  if (kBoolTrue == test_19) {
                                    test_19 = GALGAS_bool (kIsEqual, GALGAS_string ("description").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1952)))).boolEnum () ;
                                    if (kBoolTrue == test_19) {
                                      {
                                  ...
                                  if (kBoolFalse == test_19) {
                                    enumGalgasBool test_20 = kBoolTrue ;
                                    if (kBoolTrue == test_20) {
                                      test_20 = callExtensionGetter_getterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("float"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1957)).boolEnum () ;
                                      if (kBoolTrue == test_20) {
...
static void extensionSetter_gtlFloat_performSetter (cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string ("setDescription").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1979)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      ...
      GALGAS_gtlString var_descriptionToSet_61226 = temp_1 ;
      {
      object->setter_setMeta (callExtensionGetter_lstring ((const cPtr_gtlString *) var_descriptionToSet_61226.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1982)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1982)) ;
      }
  ...
  if (kBoolFalse == test_0) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (kIsEqual, GALGAS_string ("touch").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 1984)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
    ...
    if (kBoolFalse == test_2) {
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        test_3 = callExtensionGetter_setterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("float"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1987)).boolEnum () ;
        if (kBoolTrue == test_3) {
          const GALGAS_gtlFloat temp_4 = object ;
          GALGAS_gtlData var_copy_61523 = temp_4 ;
          callExtensionMethod_callSetter ((const cPtr_gtlSetter *) callExtensionGetter_getSetter ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("float"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1989)).ptr (), constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 1990)), constinArgument_context, constinArgument_lib, var_copy_61523, constinArgument_arguments, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1989)) ;
          GALGAS_gtlFloat temp_5 ;
          if (var_copy_61523.isValid ()) {
            if (NULL != dynamic_cast <const cPtr_gtlFloat *> (var_copy_61523.ptr ())) {
              temp_5 = (cPtr_gtlFloat *) var_copy_61523.ptr () ;
            }else{
              inCompiler->castError ("gtlFloat", var_copy_61523.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("gtl_data_types.galgas", 1996)) ;
            }
          }
          object->mProperty_value = temp_5.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 1996)) ;
          object->mProperty_where = var_copy_61523.getter_where (SOURCE_FILE ("gtl_data_types.galgas", 1997)) ;
          object->mProperty_meta = var_copy_61523.getter_meta (SOURCE_FILE ("gtl_data_types.galgas", 1998)) ;
        }
      }
      if (kBoolFalse == test_3) {
        TC_Array <C_FixItDescription> fixItArray6 ;

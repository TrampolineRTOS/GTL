...
fileprivate let gPopUpData_0_gtl_5F_scanner : [[UInt16]] = [
...
class SWIFT_Tokenizer_0_gtl_scanner : SWIFT_Lexique_gtl_scanner, SWIFT_Tokenizer_Protocol {
...
func tokenizerFor (extension inExtension : String) -> SWIFT_Tokenizer_Protocol? {
  ...
  if inExtension == "gtl" {
    result = SWIFT_Tokenizer_0_gtl_scanner ()
  }
  return result
}
